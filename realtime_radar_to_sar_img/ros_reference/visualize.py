...
if __name__ == "__main__":
    ...
    #sound_paths = ['20190916_112250_binary.wav', '20190916_112327_binary.wav']
    #sound_names = ['1', '2']

    #Use file name passed by argument for visualization
    print('Read file: ', sys.argv[1])
    src_path = sys.argv[1]
    src_basename = os.path.basename(src_path)
    sound_paths=[sys.argv[1]]
    sound_names=['1'] #give class number temporary
