...
|2019-10-18 **Fri**|Kar Ee와 함께 드론 기초 세팅 방법을 복습함. 시뮬레이션 시도 중|
...
|날짜|내용|
|:--:|:--:|
|2019-10-21 **Mon**|Eric교수님께 작은 드론 구매 요청, 사뮬레이션 시도 중|
|2019-10-22 **Tue**|시뮬레이션 시도 중, KSQ에서 날릴 수 있는 드론을 전달받음|
|2019-10-23 **Wed**|시뮬레이션이 되지 않아, 직접 드론을 조종해서 날리는 것이 낫다는 판단을 내림<br>작은 드론을 날려봄|
|2019-10-24 **Thr**|드론을 ksq에서 날리면서 조작법 습득 중(특히 안전한 착지 연습 중)|
|2019-10-25 **Fri**|작은드론 운전연습 및 DJI Phantom2 기본 조작접 복습|
...
|날짜|내용|
|:--:|:--:|
|2019-10-28 **Mon**|작은 드론으로 연습 중<br><br> bootstrap을 이용해 flask를 이용하여 간단하게 web 구성![Capture](https://user-images.githubusercontent.com/38516906/67721970-4512da80-f9ae-11e9-8727-ce05242077ac.PNG)|
|2019-10-29 **Tue**|드론 날리기 연습 중<br><br>web 구상도 제작<br><br>작은 드론으로 연습 중|
|2019-10-30 **Wed**|web 제작 중(back-end 기본 부분 작성)<br><br>작은 드론으로 연습 중|
|2019-10-31 **Thr**|web 제작 중(back-end 동기적: ajax 공부 중)<br><br>작은 드론으로 연습 중|
|2019-11-01 **Fri**|web 제작 중(front-end: 1차 demo버전 완성)<br><br>작은 드론으로 연습 중|
...
|날짜|내용|
|:--:|:--:|
|2019-11-04 **Mon**|web front 구조 변경(sar, wav, camera 이미지 배치)|
|2019-11-05 **Tue**|Tony 교수님과 상의 끝 농장 방문 결정: 수요일(내일) + Kar Ee 섭외|
|2019-11-06 **Wed**|Tony교수님네 농장에서 드론 날리기|
|2019-11-07 **Thr**|:car:Outlet:car:|
|2019-11-08 **Fri**|회의 때 발표할 ppt 중 해당 역할 부분 작성|
...
|날짜|내용|
|:--:|:--:|
|2019-11-11 **Mon**|회의 때 내용을 바탕으로 web front-end 최종 완성|
|2019-11-12 **Tue**||
|2019-11-13 **Wed**||
|2019-11-14 **Thr**||
|2019-11-15 **Fri**||
