...
### 2019-10-21
- 베어링이 도착하여 ball screw와 베어링 연결 -> 모터가 동작해도 ball screw가 돌아가지 않고 잘 직선 주행을 함!
- 레이더 받침대 모델링

### 2019-10-22
- 레이더의 받침대 출력, 코드 제어 연습
- 영어 수업
...
### 2019-10-24
- 보드 받침대 결과물을 받음
- GPIO가 아닌 bcm2386을 이용하여 제어를 해봄 -> gpio보다 빠르긴 하지만 그래도 여전히 2인치를 움직이는데 약 7초 정도 소요
- 영어 수업

### 2019-10-25
- 완성된 레이더 받침대로 레이더 팀과 실험을 해봄 -> 레이더 사이 거리가 멀어야 하고, 보드와의 거리가 멀어야 한다는걸 깨달음
- 헹아웃 회의
...
### 2019-10-28
- 레이더의 새로운 받침대 제작(보드가 레이더 밑으로 가게)

### 2019-10-29
- 3D 프린터의 결과물을 받았으나, 너무 커서 밑 바닥이 쪼그라들어버림 -> 두개로 나누어 다시 출력
- 아두이노와 모터 선 연결, 제어
- 영어 수업

### 2019-10-30
- 아두이노로 레일을 70초에 20인치 움직이게 하는 코드를 작성
- 아두이노에 ROS 설치 [성공](https://ibb.co/0ZQvvxJ)
- 레이더의 받침대를 반 나눠서 다시 출력
