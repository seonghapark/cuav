...
class GetFrame:
    def __init__(self):
        ...
        self.send_frame = rospy.Publisher('img_camera', sendframe, queue_size=10)
        self.net = None
        self.detect = None
        self.args = arg_parse()
    ...
    def get_frame(self, operate):
        ...
        while cap.isOpened():
            ...
            network_output = self.net.forward(get_outputs_names(self.net))

            # Extract the bounding box and draw rectangles
            self.frame_data.object, self.frame_data.percentage = detect.detect_bounding_boxes(frame, network_output)
